...
- no pause in W3 (W4 pause is strategy-sensitive operations, including auction **creation**, not ERC-20 transfers and not this slice’s settlement math)
