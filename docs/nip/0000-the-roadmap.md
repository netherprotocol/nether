...
| Strategy replacement security | v1 keeps owner + 14-day delay; a later safer adapter then a replacement lock. Draft: [`NDR-0005`](../ndr/0005-strategy-security.md) (Proposed). Do not build that proxy in W4/W5. |
...
| Strategy replacement security (owner theft vs later proxy) | W4 working posture; later NIP for the proxy | Draft: [`NDR-0005`](../ndr/0005-strategy-security.md) (Proposed). Not the W5 venue NDR |
