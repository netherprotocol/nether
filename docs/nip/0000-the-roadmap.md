...
Frontend stack is [`NDR-0003`](../ndr/0003-frontend-stack.md) (Astro static HTML, GitHub Pages, Tailwind). First public slice is [`NIP-0002`](0002-landing-docs.md): holder + Documentation from `docs/**`. Monitoring dashboard is [`NIP-0010`](0010-grave-dashboard.md). Wallet connect, bury, start auction, and sell are [`NIP-0011`](0011-wallet-connect.md) on the same tree.
...
| Frontend stack | [`NDR-0003`](../ndr/0003-frontend-stack.md); holder [`NIP-0002`](0002-landing-docs.md); dashboard [`NIP-0010`](0010-grave-dashboard.md); wallet [`NIP-0011`](0011-wallet-connect.md). Indexer still TBD (W8). |
...
M0 gate: W1–W5 tests, invariants, economic sim, Base fork tests ([`NIP-0008`](0008-e2e-fork-suite.md))
 ...
 ├─ W7 frontend (holder/docs: [`NIP-0002`](0002-landing-docs.md); dashboard: [`NIP-0010`](0010-grave-dashboard.md); wallet/bury/sell: [`NIP-0011`](0011-wallet-connect.md))
